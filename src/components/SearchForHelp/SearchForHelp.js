    ...
    return (
        <div className='container pb-3'>
            ...
            <div className="input-group mb-3 col pt-1">
                ...
                <input type="text" className="form-control form-style shadow-none" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" placeholder="Search Articles..."/>
                </div>
            </div>
